<div class="header-top">
    <div class="container">
        <div class="header-left">
            <a href="tel:#"><i class="icon-phone"></i>Call: +961/76 666 666</a>
        </div><!-- End .header-left -->
            ...
            <ul class="top-menu">
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <form action="{{route("logout")}}" method="POST"><button type="submit" class="btn btn-dark">Logout</button> @csrf</form>
                        </li>
                        @else
        ...
        <div class="header-center">
            <nav class="main-nav">
                <ul class="menu sf-arrows">
                    ...
                    <li class="@if(Route::is(" adminpanel.index")) active @endif"><a href="{{route("adminpanel.index")}}">Admin Panel</a></li>
                    @endif
                </ul><!-- End .menu -->
            </nav><!-- End .main-nav -->
